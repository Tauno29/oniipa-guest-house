...
export default function Home() {
  ...
  return (
    <main className="texture overflow-hidden">
      ...
      <section id="top" className="relative flex min-h-[760px] items-end bg-[#554138] text-white lg:min-h-[820px]"><img src={ASSETS.hero} alt="Oipapa Guesthouse rooms and self-catering kitchen" className="absolute inset-0 h-full w-full object-cover object-center" /><div className="absolute inset-0 bg-gradient-to-r from-[#2b1e18]/80 via-[#2b1e18]/35 to-transparent" /><div className="relative z-10 mx-auto w-full max-w-[1440px] px-6 pb-20 lg:px-12 lg:pb-28"><div className="max-w-[720px] reveal"><p className="eyebrow mb-5 text-[#f0d4bd]">Onhuno , helao nafidi</p><h1 className="serif max-w-[760px] text-[clamp(4.2rem,10vw,9.5rem)] leading-[.8] tracking-[-.045em]">A quiet place<br /><em>to land.</em></h1><div className="mt-10 flex flex-col gap-6 border-l border-[#f0d4bd]/70 pl-5 sm:flex-row sm:items-start sm:gap-12"><p className="max-w-[290px] text-sm leading-6 text-white/85">Clean, comfortable self-catering rooms in the open calm of Onhuno , helao nafidi.</p><a href="#stay" className="group text-[.7rem] font-bold uppercase tracking-[.15em]">Explore the stay <ArrowUpRight className="ml-2 inline h-4 w-4 transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" /></a></div></div></div><div className="absolute bottom-6 right-6 z-10 flex items-center gap-3 text-[.62rem] uppercase tracking-[.15em] text-white/70 lg:right-12"><span className="h-px w-12 bg-white/50" />Self-catering guesthouse</div></section>
